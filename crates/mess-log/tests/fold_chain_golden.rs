...
const GENESIS_7: &str =
    "84eb178e62ecee1eb7536fc4bdf2dd6a2737c209d1ca2106531163f33b41369f";

/// `frame_hash(0, ev(deposit,100))` — deposit-of-100 payload, version 0.
const FH0: &str =
    "446a38d171c5409718efebea5b8798cd40b535b3f2349b26413d7488cc4875ad";

/// `chain_step(0, 0, 0) = BLAKE3(0x02 || 0^32 || 0^32 || le64(0))`.
const CHAIN_STEP_ZERO: &str =
    "74af87d638630a6c386ea2e8d1f53cd10f49c93ee84f2ab778d930c63ae1f28a";

/// `h[4]` over the 5-event fixture (deposit 100, 50; withdraw 30, 20; deposit
/// 7) for `stream_id = 1` — the regenerated equivalent of the spike's golden
/// state.
const H4_STREAM1: &str =
    "a5d6fca0230ce75e264ac448f5ccd6dcccf2efa8204b95246a63ad30d22a9f9c";
