...
impl Default for Config {
    fn default() -> Self {
        Config {
            ...
            // hundred events, so the seal/retention path turns over constantly.
            ...
            // segment, meta, a few sealed sidecars); an fd leak climbs past this.
            fd_ceiling: 512,
...
/// to the CWD. Never `/tmp` — that is tmpfs here and the driver would refuse it.
